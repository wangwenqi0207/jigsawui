<template>
  <div class="side">
    <div class="logo">
      ...
      <router-link tag="p" to="/index" style="cursor: pointer">Jigsaw<b style="">UI</b></router-link>
    </div>
    <!--。。。。；移动端。。。。。。。-->
    <h4>移动端组件 </h4>
...
<script>
  import $ from "jquery"
    export default {
        name: "CompoSide",
      mounted(){
        $(".liTitle").stop().click(function(){
          $(this).next().stop().toggle(400);
          if(($(this).find("img").attr("src"))=="../../static/img/side01.png"){
            $(this).find("img").attr("src","../../static/img/side02.png")
          } else{
            $(this).find("img").attr("src","../../static/img/side01.png")
          }
        });
      }
    }
